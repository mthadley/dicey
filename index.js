...
/***/ function(module, exports) {
	...
	var _mthadley$dicey$Dice$circle = A2(
		_elm_lang$svg$Svg$circle,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$r('47'),
					_1: {
						ctor: '::',
	...
	var _mthadley$dicey$Header$splash = '\n  _____     __     ______     ______     __  __\n/\\  __-.  /\\ \\   /\\  ___\\   /\\  ___\\   /\\ \\_\\ \\\n\\ \\ \\/\\ \\ \\ \\ \\  \\ \\ \\____  \\ \\  __\\   \\ \\____ \\\n \\ \\____-  \\ \\_\\  \\ \\_____\\  \\ \\_____\\  \\/\\_____\\\n  \\/____/   \\/_/   \\/_____/   \\/_____/   \\/_____/\n';
	var _mthadley$dicey$Header$view = A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(_mthadley$dicey$Header$splash),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Roll some dice!'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
	...
	var _mthadley$dicey$Util$isJust = function (maybe) {
		var _p0 = maybe;
		if (_p0.ctor === 'Nothing') {
			return false;
		} else {
	...
	var _mthadley$dicey$Util$mapMaybeInt = function (msg) {
		return function (_p2) {
			return msg(
	...
	var _mthadley$dicey$Select$Click = {ctor: 'Click'};
	var _mthadley$dicey$Select$subscriptions = function (model) {
		return model.open ? _elm_lang$mouse$Mouse$clicks(
			_elm_lang$core$Basics$always(_mthadley$dicey$Select$Click)) : _elm_lang$core$Platform_Sub$none;
	};
	...
	var _mthadley$dicey$App$filterBtnDisabled = function (_p1) {
		var _p2 = _p1;
		var filterFn = function (value) {
			return function (_p3) {
				return !A2(
					_elm_lang$core$Basics$flip(
						_mthadley$dicey$App$getFilterFn(_p2.selectedFilter)),
					value,
					_p3);
			};
		};
		...
		return A2(
			...
			true,
			A3(_elm_lang$core$Maybe$map2, filtered, _p2.filterValue, _p2.rolls));
	};
	var _mthadley$dicey$App$viewStats = function (rolls) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('results-stats'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
						...
						_0: _elm_lang$html$Html$text(
							A2(
								...
								A2(
									...
									4,
									_elm_lang$core$Basics$toString(
										_mthadley$dicey$Util$average(rolls))))),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
			...
			var filterHelper = function (value) {
				return A2(
					...
					A2(
						...
						A2(_mthadley$dicey$App$getFilterFn, _p6.selectedFilter, value),
						_p6.filterValue));
			};
		...
		if (_p7.ctor === 'Nothing') {
			...
			return A2(
				...
				_elm_lang$core$List$isEmpty(_p8) ? {
					...
					ctor: '::',
					_0: _mthadley$dicey$App$viewStats(_p8),
					_1: {
						ctor: '::',
						_0: A2(_mthadley$dicey$App$viewDice, model, _p8),
						_1: {ctor: '[]'}
					}
				});
		}
	};
	var _mthadley$dicey$App$viewButtonText = function (_p9) {
		return _elm_lang$html$Html$text(
			A2(
				_elm_lang$core$Maybe$withDefault,
				'Roll!',
	...
	var _mthadley$dicey$App$rollDice = F2(
		function (size, count) {
			return A2(
				_elm_lang$core$Random$generate,
				_mthadley$dicey$App$RollResults,
				A2(
					_elm_lang$core$Random$list,
					count,
					A2(_elm_lang$core$Random$int, 1, size)));
		});
	var _mthadley$dicey$App$rollIfReady = function (_p10) {
		var _p11 = _p10;
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_elm_lang$core$Platform_Cmd$none,
			A2(
				_elm_lang$core$Maybe$map,
				_mthadley$dicey$App$rollDice(_p11.diceSize),
				_p11.diceCount));
	};
	var _mthadley$dicey$App$update = F2(
		function (msg, model) {
			...
			switch (_p12.ctor) {
				case 'ApplyFilter':
					var filterHelper = function (_p13) {
						return _elm_lang$core$List$filter(
							_elm_lang$core$Basics$flip(
								_mthadley$dicey$App$getFilterFn(model.selectedFilter))(_p13));
					};
				...
				case 'ChangeDiceCount':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{diceCount: _p12._0, rolls: _elm_lang$core$Maybe$Nothing}),
						{ctor: '[]'});
				case 'ChangeSize':
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{diceSize: _p12._0, rolls: _elm_lang$core$Maybe$Nothing});
					return {
						ctor: '_Tuple2',
						_0: newModel,
				...
				case 'FilterDropdownMsg':
					var _p14 = A2(_mthadley$dicey$Select$update, _p12._0, model.filterDropdown);
					var newModel = _p14._0;
					var selected = _p14._1;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
				...
				default:
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								rolls: _elm_lang$core$Maybe$Just(_p12._0)
							}),
						{ctor: '[]'});
			}
		});
	...
	var _mthadley$dicey$App$subscriptions = function (_p15) {
		var _p16 = _p15;
		return A2(
			_elm_lang$core$Platform_Sub$map,
			_mthadley$dicey$App$FilterDropdownMsg,
			_mthadley$dicey$Select$subscriptions(_p16.filterDropdown));
	};
	...
	var _mthadley$dicey$App$viewDiceSelector = function (selectedSize) {
		var sizeSelector = function (size) {
			return A2(
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('dice-selector'),
				_1: {ctor: '[]'}
			},
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('dice-form'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onSubmit(_mthadley$dicey$App$Roll),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$for('diceCount'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('How many dice?'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Number of sides?'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: _mthadley$dicey$App$viewDiceSelector(model.diceSize),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
				...
				_1: {
					ctor: '::',
					_0: _mthadley$dicey$App$viewResults(model),
					_1: {ctor: '[]'}
				}
			});
	};
	var _mthadley$dicey$App$view = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			{
				ctor: '::',
				_0: _mthadley$dicey$Header$view,
				_1: {
					ctor: '::',
					_0: _mthadley$dicey$App$viewMain(model),
					_1: {ctor: '[]'}
				}
			});
	};

	var _mthadley$dicey$Main$main = _elm_lang$html$Html$program(
		{init: _mthadley$dicey$App$init, view: _mthadley$dicey$App$view, update: _mthadley$dicey$App$update, subscriptions: _mthadley$dicey$App$subscriptions})();

	var Elm = {};
	Elm['Main'] = Elm['Main'] || {};
	if (typeof _mthadley$dicey$Main$main !== 'undefined') {
	    _mthadley$dicey$Main$main(Elm['Main'], 'Main', undefined);
	}
